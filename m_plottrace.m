...
ts4 = (1:N4) / 120;
ts5 = (1:N5) / 120;
% pos_m_trim = pos_m(54:end-54, :);
pos_m_trim11 = pos_m1(:, :);
pos_m_trim21 = pos_m2(:, :);
pos_m_trim31 = pos_m3(:, :);
pos_m_trim41 = pos_m4(:, :);
pos_m_trim51 = pos_m5(:, :);
ts11 = ts(1:length(pos_m_trim11));
% ts = ts-min(ts);

figure;
subplot(5, 1, 1)
plot(ts1(:), pos_m_trim11(:, 1) - pos_m1(1, 1), 'LineWidth', 1.5)
set(gca, "TickLabelInterpreter", "latex", "FontSize", 18)
...
subplot(5, 1, 2)
plot(ts2(:), pos_m_trim21(:, 1) - pos_m2(1, 1), 'LineWidth', 1.5)
set(gca, "TickLabelInterpreter", "latex", "FontSize", 18)
ylabel("$A_t$ [m]", "Interpreter", "latex")
yticks(-0.05:0.01:0.05)
ylim([-0.05 0.05])
...
subplot(5, 1, 3)
plot(ts3(:), pos_m_trim31(:, 1) - pos_m3(1, 1), 'LineWidth', 1.5)
set(gca, "TickLabelInterpreter", "latex", "FontSize", 18)
ylabel("$A_t$ [m]", "Interpreter", "latex")
yticks(-0.05:0.01:0.05)
ylim([-0.05 0.05])
...
subplot(5, 1, 4)
plot(ts4(:), pos_m_trim41(:, 1) - pos_m4(1, 1), 'LineWidth', 1.5)
set(gca, "TickLabelInterpreter", "latex", "FontSize", 18)
ylabel("$A_t$ [m]", "Interpreter", "latex")
yticks(-0.05:0.01:0.05)
ylim([-0.05 0.05])
...
subplot(5, 1, 5)
plot(ts5(:), pos_m_trim51(:, 1) - pos_m5(1, 1), 'LineWidth', 1.5)
set(gca, "TickLabelInterpreter", "latex", "FontSize", 18)
ylabel("$A_t$ [m]", "Interpreter", "latex")
yticks(-0.05:0.01:0.05)
ylim([-0.05 0.05])
